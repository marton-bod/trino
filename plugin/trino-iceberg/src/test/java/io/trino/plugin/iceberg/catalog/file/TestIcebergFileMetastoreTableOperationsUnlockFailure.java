        ...
        extends AbstractTestQueryFramework
{
    ...
    protected LocalQueryRunner createQueryRunner()
    {
        ...
        ThriftMetastore thriftMetastore = metastoreWithUnlockFailure();
        HiveMetastore metastore = new BridgingHiveMetastore(thriftMetastore);

        LocalQueryRunner queryRunner = LocalQueryRunner.create(session);

        queryRunner.createCatalog(
                ICEBERG_CATALOG,
                new TestingIcebergConnectorFactory(Optional.of(new TestingIcebergHiveMetastoreCatalogModule(thriftMetastore, metastore)), Optional.empty(), EMPTY_MODULE),
                ImmutableMap.of());
    ...
    private InMemoryThriftMetastore metastoreWithUnlockFailure() {
